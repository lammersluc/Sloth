...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    } catch (e) { if (e.toLocaleString().includes('DisTubeError [NO_RESULT]: No result found')) return message.channel.send({ embeds: [embed.setDescription(`No results found for \`${string}\`.`)] }); }
